...
birch_clu = Birch(n_clusters=4)  # Adjust parameters as needed
birch_labels = birch_clu.fit_predict(Xnew)

dfcluster = pd.DataFrame(birch_labels, columns=['cluster'])
...
unique_clusters = set(birch_labels)
